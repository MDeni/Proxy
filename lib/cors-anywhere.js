...
function withCORS(headers, request) {
  ...
  headers['access-control-allow-origin'] = 'https://h6nztsbktj7wp8qd2lh5ia-on.drv.tw';
...
exports.createServer = function createServer(options) {
  ...
  proxy.on('error', function(err, req, res) {
    ...
    res.writeHead(404, {'Access-Control-Allow-Origin': 'https://h6nztsbktj7wp8qd2lh5ia-on.drv.tw'});
