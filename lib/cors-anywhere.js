...
function withCORS(headers, request) {
  ...
  headers['access-control-allow-origin'] = 'https://h6nztsbktj7wp8qd2lh5ia-on.drv.tw/SendingPositionTestWebpage';
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  var requestState = req.corsAnywhereRequestState;
      ...
      console.log('proxyRespond1 : ',req.corsAnywhereRequestState);
...
exports.createServer = function createServer(options) {
  ...
  proxy.on('error', function(err, req, res) {
    ...
    res.writeHead(404, {'Access-Control-Allow-Origin': 'https://h6nztsbktj7wp8qd2lh5ia-on.drv.tw/SendingPositionTestWebpage'});
